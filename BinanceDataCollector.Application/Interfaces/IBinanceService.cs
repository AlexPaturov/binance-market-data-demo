...
public interface IBinanceService
{
    ...
    Task<IEnumerable<IBinanceRecentTrade>> GetHistoricalAggTradesAsync(string symbol, DateTime startTime, DateTime endTime, CancellationToken cancellationToken);
}
