...
public interface ITradeRepository
{
    ...
    /// <returns>
    /// Сколько минут снято с очереди. Ноль — очередь пуста: по этому признаку потребитель
    /// понимает, что дошёл до дна. Минута без тиков свечи не даёт, но с очереди уходит,
    /// поэтому счёт идёт по минутам, а не по построенным свечам.
    /// </returns>
